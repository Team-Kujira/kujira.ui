...
function signAndBroadcast({ rpc, signer, messages, sourceAccount, sourceChainData, }) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const query = (0, kujira_js_1.kujiraQueryClient)({ client: tm });
        ...
        const txBodyBytes = kujira_js_1.registry.encode(txBodyEncodeObject);
        const gasPrice = 25;
        ...
        const client = yield stargate_1.SigningStargateClient.connectWithSigner(rpc, signer, {
            ...
            aminoTypes: (0, kujira_js_1.aminoTypes)("evmos"),
        });
