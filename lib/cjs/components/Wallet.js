...
exports.Network = exports.KujiConnected = exports.KujiUnconnected = exports.Wallet = exports.NetworkWarning = exports.NetworkSelect = void 0;
...
const NetworkSelect = ({ onChange, }) => {
    const [{ network }] = (0, useNetwork_1.useNetwork)();
    ...
    return ((0, jsx_runtime_1.jsx)(jsx_runtime_1.Fragment, { children: Object.entries(kujira_js_1.NETWORKS).length > 1 && ((0, jsx_runtime_1.jsx)(Select_1.Select, { className: "w-full condensed select--light select--tight mb-1", selected: {
                label: names[network],
                value: network,
...
function Wallet({ adapter = wallet_1.useWallet, }) {
    ...
    if (account) {
        return ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)(exports.NetworkWarning, {}), (0, jsx_runtime_1.jsxs)("div", Object.assign({ className: "md-button md-button--grey md-button--outline" }, { children: [account ? (0, jsx_runtime_1.jsx)(exports.KujiConnected, {}) : (0, jsx_runtime_1.jsx)(exports.KujiUnconnected, {}), (0, jsx_runtime_1.jsxs)("span", Object.assign({ className: "desktop color-white" }, { children: [account.address.substr(0, 6), "...", account.address.substr(-6)] })), (0, jsx_runtime_1.jsxs)("span", Object.assign({ className: "mobile color-white" }, { children: [account.address.substr(0, 3), "...", account.address.substr(-3)] }))] })), (0, jsx_runtime_1.jsxs)("div", Object.assign({ className: "wallet__popup" }, { children: [Object.keys(kujira_js_1.NETWORKS).includes(chainInfo.chainId) && ((0, jsx_runtime_1.jsx)(exports.NetworkSelect, { onChange: (n) => connect && connect(n) })), (0, jsx_runtime_1.jsxs)("small", Object.assign({ className: "network" }, { children: ["Network: ", chainInfo.chainId] })), (0, jsx_runtime_1.jsxs)("span", Object.assign({ className: "address mb-2" }, { children: [account.address.substr(0, 16), "...", account.address.substr(-16), (0, jsx_runtime_1.jsx)("div", Object.assign({ className: "copy", onClick: () => {
                                        navigator.clipboard.writeText(account.address || "");
                                        react_hot_toast_1.toast.success(i18n.t("Copied address to clipboard"));
                                    } }, { children: (0, jsx_runtime_1.jsx)(IconCopy_1.IconCopy, {}) }))] })), (0, jsx_runtime_1.jsx)("table", Object.assign({ className: "balances" }, { children: (0, jsx_runtime_1.jsx)("tbody", { children: balances === null || balances === void 0 ? void 0 : balances.map((b) => ((0, jsx_runtime_1.jsx)(Balance, { balance: b }, b.denom))) }) })), (0, jsx_runtime_1.jsx)("div", Object.assign({ className: "md-flex jc-e mb-1 pr-1" }, { children: (0, jsx_runtime_1.jsxs)("button", Object.assign({ className: "transparent md-flex ai-c jc-e mr-0 ml-a pointer", onClick: () => setShowKado(true) }, { children: [(0, jsx_runtime_1.jsx)(IconKado_1.IconKado, {}), (0, jsx_runtime_1.jsx)("span", Object.assign({ className: "fs-12 color-white ml-1 fw-600" }, { children: "Fund with Kado" }))] })) })), (0, jsx_runtime_1.jsx)(i18n.button, Object.assign({ className: "md-button md-button--grey md-button--outline disconnect", onClick: () => {
                                disconnect();
                            } }, { children: "Disconnect Wallet" }))] })), showKado && (0, jsx_runtime_1.jsx)(KadoModal_1.default, { onClose: () => setShowKado(false) })] }));
    }
    return ((0, jsx_runtime_1.jsx)(jsx_runtime_1.Fragment, { children: (0, jsx_runtime_1.jsxs)("button", Object.assign({ onClick: () => connect && connect(), className: "md-button md-button--grey md-button--nowrap" }, { children: [(0, jsx_runtime_1.jsx)(IconWallet_1.IconWallet, {}), (0, jsx_runtime_1.jsx)(i18n.span, { children: "Connect Wallet" })] })) }));
}
exports.Wallet = Wallet;
const Balance = ({ balance }) => {
    const denom = kujira_js_1.Denom.from(balance.denom || "");
    const { feeDenom, setFeeDenom } = (0, wallet_1.useWallet)();
    const [{ chainInfo }] = (0, useNetwork_1.useNetwork)();
