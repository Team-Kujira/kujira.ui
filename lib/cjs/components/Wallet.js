...
exports.KujiConnected = exports.KujiUnconnected = exports.Wallet = exports.NetworkWarning = void 0;
...
function Wallet({ adapter = wallet_1.useWallet, }) {
    ...
    return ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsxs)("button", Object.assign({ onClick: () => setShowWalletSelect(!showWalletSelect), className: "md-button md-button--grey md-button--nowrap" }, { children: [(0, jsx_runtime_1.jsx)(IconWallet_1.IconWallet, {}), (0, jsx_runtime_1.jsx)(i18n.span, { children: "Connect Wallet" })] })), showWalletSelect && ((0, jsx_runtime_1.jsxs)("div", Object.assign({ className: "wallet__connections" }, { children: [(0, jsx_runtime_1.jsx)("button", Object.assign({ className: "transparent block pointer", onClick: () => {
                        ...
                        } }, { children: (0, jsx_runtime_1.jsx)("img", { src: "https://github.com/chainapsis/keplr-wallet/blob/master/packages/mobile/src/assets/logo/keplr-logo-dark-mode.png?raw=true" }) })), (0, jsx_runtime_1.jsx)("hr", { className: "hr my-2" }), (0, jsx_runtime_1.jsx)("button", Object.assign({ className: "transparent block pointer color-white fw-600 fs-12 p-2", onClick: () => {
