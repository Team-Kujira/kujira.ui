...
export function Wallet({
  ...
  if (account) {
    return (
      <>
        <NetworkWarning />
        <div className="md-button md-button--grey md-button--outline">
          {account ? <KujiConnected /> : <KujiUnconnected />}
...
export const KujiConnected = () => (
  <svg
    ...
    <g clipPath="url(#a)" transform="translate(.669)">
      <path fill="#60fbd0" d="M0 0h80v80H0V0z" />
    </g>
  </svg>
);

export const Network = ({ onClick }: { onClick: () => void }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 512 512"
