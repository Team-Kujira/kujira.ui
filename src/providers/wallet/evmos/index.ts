...
import { COSMOS_API } from "kujira-core/src/hooks/cosmos/utils";
import { aminoTypes, kujiraQueryClient, registry } from "kujira.js";
...
export async function signAndBroadcast({
  ...
  const client = await SigningStargateClient.connectWithSigner(
    `${COSMOS_API}/evmos/rpc`,
    signer,
    { registry, aminoTypes: aminoTypes("evmos") }
  );
