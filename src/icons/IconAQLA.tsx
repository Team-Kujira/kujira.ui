...
export const IconAQLA: FC<JSX.IntrinsicElements["svg"]> = (props) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="414.907 361.882 294.991 287.464"
    className="icon-denom"
    xmlSpace="preserve">
    <g
      opacity="1"
      transform="matrix(.93648 0 0 .93648 414.977 361.905)">
      <g>
        <linearGradient
          id="aqla"
          x1="158.437"
          ...
          <stop offset="1" stopColor="rgba(1, 254, 191, 1)"></stop>
        </linearGradient>
        <path
          fill="url(#aqla)"
