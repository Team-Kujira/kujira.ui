...
export const IconRKUJI = () => (
  <svg
    ...
    <g fill="none" fillRule="evenodd">
      <circle cx="50" cy="50" r="50" fill="url(#rkiki)" />
      <path
        fill="#FFF"
        d="m30.143 18 4.12 2.887-4.382 6.262H42.62v5.034l-.006-.001-2.64 3.775 8.932.001v26.425H21.247V39.491l-2.128 3.042L15 39.646 30.143 18Zm2.419 33.058h-6.286v6.291h6.286v-6.291Zm11.314 0H37.59v6.291h6.286v-6.291ZM32.562 40.991h-6.286v6.292h6.286v-6.292Zm11.314 0H37.59v6.292h6.286v-6.292Zm-7.401-8.809H26.36l-2.641 3.775h10.115l2.641-3.775ZM57.706 80v-5.033l6.286-.001V57.349H53.934V35.959h25.144V57.35l-10.058-.001V80H57.707Zm18.387-18.875L83 75.95l-4.558 2.127-6.907-14.826 4.558-2.127Zm-19.891 0 4.558 2.127-4.782 10.264-4.558-2.127 4.782-10.264ZM74.049 40.99H58.963v11.325h15.086V40.991Zm-11.898-21.76 7.911 7.918h9.016v5.034H53.934V27.15l9.016-.001-4.355-4.359 3.556-3.56ZM21.247 66.158h5.029v11.325h-5.029Zm7.543 0h5.03v11.325h-5.03Zm7.544 0h5.028v11.325h-5.028Zm7.543 0h5.029v5.034h-5.03Z"
      />
    </g>
  </svg>
);
...
const IconNLS = () => (
  <svg
    className="icon-denom"
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 31.249 31.249">
    <g data-name="Group 664">
      <g data-name="Group 198">
        <path
          fill="#f50"
          d="M15.624 0a15.625 15.625 0 1 0 15.625 15.625A15.625 15.625 0 0 0 15.624 0Zm5.463 23.437H10.161a2.35 2.35 0 0 1-2.35-2.35V10.162a2.35 2.35 0 0 1 2.35-2.35h10.926a2.35 2.35 0 0 1 2.349 2.35v10.925a2.35 2.35 0 0 1-2.349 2.35Z"
          data-name="Path 19"
        />
      </g>
    </g>
