...
export const EthAccount = {
  ...
  decode(input: Reader | Uint8Array, length?: number): EthAccount {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.base_account = BaseAccount.decode(
            reader,
            reader.uint32()
          );
          break;
  ...
  fromJSON(object: any): EthAccount {
    const message = { ...baseEthAccount } as EthAccount;
    if (
      object.base_account !== undefined &&
      object.base_account !== null
    ) {
      message.base_account = BaseAccount.fromJSON(
        object.base_account
      );
    } else {
...
export const Params = {
  ...
  fromJSON(object: any): Params {
    ...
    if (
      ...
      message.max_memo_characters = Number(
        object.max_memo_characters
      );
    } else {
      message.max_memo_characters = 0;
    }
    if (
      object.tx_sig_limit !== undefined &&
    ...
    if (
      ...
      message.tx_size_cost_per_byte = Number(
    ...
    if (
      ...
      message.sig_verify_cost_ed25519 = Number(
